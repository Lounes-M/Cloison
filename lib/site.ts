...
export const site = {
  ...
  description:
    "Cloison prend la caution locative de A à Z. Tu crées ton dossier, ton garant dépose ses pièces de son côté, l'agence reçoit un dossier complet. Personne ne voit ce qu'il ne doit pas voir.",
