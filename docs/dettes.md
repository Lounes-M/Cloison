...
### Controle de derive du schema deploye, surveillance a maintenir
...
ne prouvait pas une absence de derive ulterieure de Supabase. La PR 56 a deploye les empreintes approuvees et le controle planifie. Supervision 34043331193 est verte ; les executions GitHub restent sans cadence garantie. Voir docs/exploitation/derive-schema.md pour maintenir la reference lors de chaque migration.
